        ...
        <div id="head">
            <div id="head_cen">
                <div id="head_sup" class="head_pad">
                    <form class="log-in"method="post" action="views/Message/login.php" id="formlogin" name="formlogin" >
                        <label>Nick</label>
                ...
                <div id="content_sup" class="head_pad">
                    ...
                    <div id="welcom_pan">
                        ...
                        <div id="Register">
                            ...
                            <form method="post" action="views/Message/RegisterGood.php" class="iform" value="redister" id="register" name="register">
                    ...
                    <div id="welcom_pan">
                        <h2><a href="views/desription.php"><img src="public/images/blog_footrt.jpg" width="940" height="200"/></a></h2>
                        <div id="Register">
