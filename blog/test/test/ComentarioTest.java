...
*/		  
		    ...
		    /**
		     * Prueba encarga de solicitar un token para el usuario registrado en la prueba 1 de comentarioTest, inserta un nuevo comentario con este usuario, y este 
	...
	*/	    
	...
	/*	    @Test
		    public void eliminarComentarioNoPropietarioTest(){
				...
				Test2.setClave("1234");
				UsuarioOD test = gestorusuario.Login(Test2, "localhost");
				Assert.assertEquals("Renato", test.getNombre());
				
				ComentarioOD comentario = new ComentarioOD();
				comentario.setId_c(2);
				String eliminado = gestorcomentario.eliminar(comentario,test.getToken(),test.getId_u());
